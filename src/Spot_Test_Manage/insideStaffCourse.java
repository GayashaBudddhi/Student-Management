 ...
 */
public class insideStaffCourse extends javax.swing.JFrame {
    public String last;
    Timer timer;
    /**
     * Creates new form studentLog
     */
    public insideStaffCourse() {
        initComponents();
    }

    public insideStaffCourse(String para) {
        initComponents();
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        this.setVisible(false);
        String namee=namereq.getText();
        new CourseManagemegt.Course_Management(namee).setVisible(true);
    }//GEN-LAST:event_jLabel7MouseClicked

    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        try {
            // TODO add your handling code here:
            Desktop.getDesktop().browse(new URL("https://drive.google.com/open?id=1gcIGU1Uyi5yYK4RI2ifBCyVWVS83WcGk").toURI());
        } catch (MalformedURLException ex) {
            Logger.getLogger(insideStaffCourse.class.getName()).log(Level.SEVERE, null, ex);
 ...
 private void resetColor(JPanel panel) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(insideStaffCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new insideStaffCourse().setVisible(true);
